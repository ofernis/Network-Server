...
void requestError(int fd, char *cause, char *errnum, char *shortmsg, char *longmsg, struct stats_t stats) 
{
   ...
   int id = stats.handler_thread_stats.handler_thread_id;
...
void requestServeDynamic(int fd, char *filename, char *cgiargs, struct stats_t stats)
{
...
void requestServeStatic(int fd, char *filename, int filesize, struct stats_t stats) 
{
   int srcfd;
